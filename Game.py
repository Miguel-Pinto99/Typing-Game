...
def main():
    ...
    if args["use_time_mode"] is False:
        print(
            "Type all " + str(args["maximum_value"]) + " characters to finish the test."
        )
...
def withoutTime(args):
    ...
    print(
        "\n {} Your test has ended, here are the results: {}".format(
...
def withTime(args):
    ...
    print(
        "\nCurrent test duration {} exceeds maximum of {} seconds".format(
            test_duration, args["maximum_value"]
        )
    )
